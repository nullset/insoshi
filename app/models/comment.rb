...
class Comment < ActiveRecord::Base
  ...
  # named_scope :all, :conditions => "approved_by is not null or approved_by != '' and rejected is not true", :order => "created_at asc"
  named_scope :all, :conditions => "rejected is not true", :order => "created_at asc"
